...
public class OrderRoomCleaning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_room_cleaning);
        ...
        if (isConnected == false) {
            Intent intent = new Intent(OrderRoomCleaning.this, NoInternet.class);
        ...
        if (address.isEmpty()) {
            Intent toUserLocation = new Intent(OrderRoomCleaning.this, UserLocation.class);
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(OrderRoomCleaning.this);
        db.collection("Taxes")
    ...
    public void changeLocation(View view) {
        Intent intent = new Intent(OrderRoomCleaning.this, UserLocation.class);
        startActivity(intent);
    }
    public void moreInfoActivity(View view){
        Intent intent = new Intent(OrderRoomCleaning.this, moreInfoActivity.class);
        intent.putExtra("showInfoOf", "RoomCleaning");
        startActivity(intent);
    }
    String latitude;
    String longitude;
        ...
        */
        ...
        if (roomString.isEmpty()) {
            ...
            if (acct != null) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(OrderRoomCleaning.this);
                alert.setTitle("Room Cleaning Service Add To Cart");
                db.collection("Prices")
                        .whereEqualTo("ServiceId", "RoomCleaning")
                        .get()
                        .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                            String roomCleaningPriceString;
                            @Override
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    alert.setPositiveButton("Yes, Add To Cart", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            ...
                                            cartData.put("category", "RoomCleaning");
                                            ...
                                            cartData.put("service_needed", "Full Room Cleaning");
                                            cartData.put("roomCount", roomString);
                                            cartData.put("numberOf_CopyOf_selected_hint", roomString);
                                            cartData.put("serviceimage", "https://firebasestorage.googleapis.com/v0/b/hrm-eco-services.appspot.com/o/homepage_images%2Froom.jpeg?alt=media&token=17912ad4-8916-4331-a24f-44c68a979e36");
                                            ...
                                            db.collection("Cart").add(cartData)
                                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                        ...
                                                        public void onSuccess(DocumentReference documentReference) {
                                                            Toast.makeText(OrderRoomCleaning.this, "Added To Cart", Toast.LENGTH_SHORT).show();
                                                            Intent intent = new Intent(OrderRoomCleaning.this, MainActivity.class);
                                                    ...
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        ...
                                                        public void onFailure(@NonNull Exception e) {
                                                            Toast.makeText(OrderRoomCleaning.this, "Some Error Occurred Please Try Again Later", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                        }
                                    });
                                    ...
                                    Toast.makeText(OrderRoomCleaning.this, "Some Error Occurred While Getting The Prices", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
