...
public class OrderBathroomCleaning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_bathroom_cleaning);
        ...
        if (isConnected == false) {
            Intent intent = new Intent(OrderBathroomCleaning.this, NoInternet.class);
        ...
        if (address.isEmpty()) {
            Intent toUserLocation = new Intent(OrderBathroomCleaning.this, UserLocation.class);
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(OrderBathroomCleaning.this);
        db.collection("Taxes")
    ...
    public void changeLocation(View view) {
        Intent intent = new Intent(OrderBathroomCleaning.this, UserLocation.class);
        startActivity(intent);
    }
    public void moreInfoActivity(View view){
        Intent intent = new Intent(OrderBathroomCleaning.this, moreInfoActivity.class);
        intent.putExtra("showInfoOf", "BathroomCleaning");
        startActivity(intent);
    }
    String latitude;
    String longitude;
    ...
    public void addToCart(View view) {
        ...
        */
        ...
        String BathroomString = Bathrooms.getText().toString();
        if (BathroomString.isEmpty()) {
            Bathrooms.setError("This Field Can't Be Empty");
        } else {
            if (address.isEmpty()) {
            ...
            if (acct != null) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(OrderBathroomCleaning.this);
                alert.setTitle("Bathrooms Cleaning Service Add To Cart");
                db.collection("Prices")
                        .whereEqualTo("ServiceId", "BathroomCleaning")
                        .get()
                        .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                if (task.isSuccessful()) {
                                    for (QueryDocumentSnapshot document : task.getResult()) {
                                        Log.d("DATA", document.getId() + " => " + document.getData());
                                        BathroomsCleaningPriceString = document.get("BathroomCleaningPrice").toString();
                                    }
                                    int roomTotalPrice = Integer.parseInt(BathroomsCleaningPriceString)*Integer.parseInt(BathroomString);
                                    ...
                                    alert.setPositiveButton("Yes, Add To Cart", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            ...
                                            cartData.put("service_needed", "Full Bathrooms Cleaning");
                                            cartData.put("BathroomCount", BathroomString);
                                            cartData.put("numberOf_CopyOf_selected_hint", BathroomString);
                                            cartData.put("serviceimage", "https://firebasestorage.googleapis.com/v0/b/hrm-eco-services.appspot.com/o/homepage_images%2Fbathroom.jpeg?alt=media&token=eef68b9c-4a0a-4363-9512-e5ce694d3759");
                                            ...
                                            db.collection("Cart").add(cartData)
                                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                        ...
                                                        public void onSuccess(DocumentReference documentReference) {
                                                            Toast.makeText(OrderBathroomCleaning.this, "Added To Cart", Toast.LENGTH_SHORT).show();
                                                            Intent intent = new Intent(OrderBathroomCleaning.this, MainActivity.class);
                                                    ...
                                                    .addOnFailureListener(new OnFailureListener() {
                                                        ...
                                                        public void onFailure(@NonNull Exception e) {
                                                            Toast.makeText(OrderBathroomCleaning.this, "Some Error Occurred Please Try Again Later", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                        }
                                    });
                                    ...
                                    Toast.makeText(OrderBathroomCleaning.this, "Some Error Occurred While Getting The Prices", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
